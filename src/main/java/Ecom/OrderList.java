...
public class OrderList {
	...
	public static ArrayList<OrderList> getAllOrders(){
        ...
        String sql = "SELECT commande.cid,utilisateur.prenon,utilisateur.nom,produit.nom,commande.date_commande,commande.date_livraison from utilisateur inner join commande using (uid) inner join produits_commande using (cid) inner join produit using (pid)";
        try {
