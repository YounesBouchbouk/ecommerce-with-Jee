...
Enveloppes rinomicine 10 enveloppes                                    
                                ...
                                <div class="col-12">
                                    <ul>
                                        <li>Il soulage les sympt�mes de la grippe, catarral, refroidissement et les �tats de rhume qui se produisent avec la douleur voit ou mod�re, maux de t�te, fi�vre et congestion nasale.</li>
                                    </ul>
                                </div>
                            </div>
                            <!-- Product Info -->
